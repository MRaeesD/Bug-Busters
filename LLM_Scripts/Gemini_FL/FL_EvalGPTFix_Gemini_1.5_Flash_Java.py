...
output_csv1 = './Responses/EvalGPTFix_Gemini/zero_shot_Gemini_1.5_Flash_EvalGPTFix.csv'
output_csv2 = './Responses/EvalGPTFix_Gemini/one_shot_Gemini_1.5_Flash_EvalGPTFix.csv'
